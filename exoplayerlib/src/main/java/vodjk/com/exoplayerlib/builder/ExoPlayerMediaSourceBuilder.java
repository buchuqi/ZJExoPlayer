...
public class ExoPlayerMediaSourceBuilder {
    private static final String TAG = ExoPlayerMediaSourceBuilder.class.getName();
    ...
    private void initDataConcatenatingMediaSource(Uri firstVideoUri, Uri secondVideoUri) {
        ...
        switch (streamType) {
            case C.TYPE_SS:
                MediaSource secondSource = new SsMediaSource(secondVideoUri, new DefaultDataSourceFactory(context, null, getHttpDataSourceFactory()),
